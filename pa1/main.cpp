...
int main(int argc, char **argv) {
    ...
    // }
    // node =
    // Node8{-4.774632, -1.743861, -3.298099, 4.774321, 1.743861, 2.478228};
    // Triangle testt{
    // vec3{-0.000838, -1.212288, -0.734695},
    // vec3{0.063417, -1.210897, -0.609358},
    // vec3{-0.000173, -1.210655, -0.607831},
    // };
    // if (node.owns(testt)) {
    // printf("yes\n");
    // } else {
    // printf("?\n");
    // }
    // flt const &x = node.midcord[0];
    // printf("%d\n", sign(testt.a().x - x) * sign(testt.b().x - x));
    // printf("%d\n", sign(testt.b().x - x) * sign(testt.c().x - x));
    // std::vector<Triangle> tlist;
    // for (auto const &t : node.facets) {
    // tlist.push_back(t);
    // }
    // Scene world(tlist);
